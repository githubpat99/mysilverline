import { SL_API_BASE } from "./config";
...
export const API_POSITIONS_REPLACE = `${SL_API_BASE}/positions/replace`;
export const API_LOGOUT = `${SL_API_BASE}/logout`;

// später:
export const API_PROFILE_RESET = `${SL_API_BASE}/profile/reset`;
